...
export const newDrugs27: Drug[] = [
  {
    name: 'Zopiclona Hemiadipato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemiadipato', 'Imovane®'],
    highlights: [
  ...
  {
    name: 'Zolpidem Hemifosfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Hemifosfato', 'Stilnox®'],
    highlights: [
  ...
  {
    name: 'Zopiclona Hemifosfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemifosfato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
  ...
  {
    name: 'Zolpidem Hemibrometo',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Hemibrometo', 'Stilnox®'],
    highlights: [
      'Hipnótico de ação rápida.',
      'Induz sono rapidamente.',
      'Meia-vida curta.',
  ...
  {
    name: 'Zopiclona Hemibrometo',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemibrometo', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
