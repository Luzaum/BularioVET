...
export const newDrugs23: Drug[] = [
  {
    name: 'Zopiclona Maleato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Maleato', 'Imovane®'],
    highlights: [
  ...
  {
    name: 'Zolpidem Sulfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Sulfato', 'Stilnox®'],
    highlights: [
  ...
  {
    name: 'Zopiclona Sulfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Sulfato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
  ...
  {
    name: 'Zolpidem Cloridrato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Cloridrato', 'Stilnox®'],
    highlights: [
      'Hipnótico de ação rápida.',
      'Induz sono rapidamente.',
      'Meia-vida curta.',
  ...
  {
    name: 'Zopiclona Cloridrato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Cloridrato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
