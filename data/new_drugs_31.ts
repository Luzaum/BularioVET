...
export const newDrugs31: Drug[] = [
  {
    name: 'Zopiclona Hemigluconato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemigluconato', 'Imovane®'],
    highlights: [
  ...
  {
    name: 'Zolpidem Hemisulfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Hemisulfato', 'Stilnox®'],
    highlights: [
  ...
  {
    name: 'Zopiclona Hemisulfato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemisulfato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
  ...
  {
    name: 'Zolpidem Heminitrato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Heminitrato', 'Stilnox®'],
    highlights: [
      'Hipnótico de ação rápida.',
      'Induz sono rapidamente.',
      'Meia-vida curta.',
  ...
  {
    name: 'Zopiclona Heminitrato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Heminitrato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
