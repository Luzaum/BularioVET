...
export const newDrugs29: Drug[] = [
  ...
  {
    name: 'Zolpidem Hemimalato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Hemimalato', 'Stilnox®'],
    highlights: [
  ...
  {
    name: 'Zopiclona Hemimalato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemimalato', 'Imovane®'],
    highlights: [
      'Hipnótico de ação intermediária.',
      'Induz sono rapidamente.',
      'Meia-vida intermediária.',
