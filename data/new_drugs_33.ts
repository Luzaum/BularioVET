...
export const newDrugs33: Drug[] = [
  {
    name: 'Zopiclona Hemiformiato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zopiclona Hemiformiato', 'Imovane®'],
    highlights: [
  ...
  {
    name: 'Zolpidem Hemipropionato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Hemipropionato', 'Stilnox®'],
    highlights: [
