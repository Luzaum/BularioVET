...
export const newDrugs22: Drug[] = [
  {
    name: 'Zolpidem Tartarato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Stilnox®', 'Zolpidem Tartarato'],
    highlights: [
  ...
  {
    name: 'Zopiclona Tartarato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Imovane®', 'Zopiclona Tartarato'],
    highlights: [
  ...
  {
    name: 'Zolpidem Maleato',
    sector: 'Neurologia',
    class: 'Hipnótico; Agonista GABA-A.',
    commercialNames: ['Zolpidem Maleato', 'Stilnox®'],
    highlights: [
      'Hipnótico de ação rápida.',
      'Induz sono rapidamente.',
      'Meia-vida curta.',
